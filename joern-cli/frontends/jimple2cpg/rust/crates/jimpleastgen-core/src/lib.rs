...
//! JVM instruction-set control/data-flow semantics) remains owned by **Soot** on
//! the Scala side (`io.joern.jimple2cpg.JimpleParserBackend.Soot`).
//!
//! This crate owns the Rust side of JVM input discovery and declaration
