...
// Generated: April 22, 2026 at 12:46:14 PM UTC
...
object SwiftNodeSyntax {
  ...
  def createSwiftNode(json: Value): SwiftNode = {
    ...
    if (nodeType.nonEmpty) {
      ...
      val prefix = {
        val i = tokenKind.indexOf('('); if (i >= 0) tokenKind.substring(0, i) else tokenKind
      }
  ...
  private val _nodeTypeMap: Map[String, Value => SwiftNode] = Map(
    "ABIAttributeArgumentsSyntax"                  -> (json => ABIAttributeArgumentsSyntax(json)),
    "AccessorBlockFileSyntax"                      -> (json => AccessorBlockFileSyntax(json)),
    ...
    "AttributeClauseFileSyntax"                    -> (json => AttributeClauseFileSyntax(json)),
    ...
    "AvailabilityMacroDefinitionFileSyntax"        -> (json => AvailabilityMacroDefinitionFileSyntax(json)),
    ...
    "_CanImportExprSyntax"                         -> (json => _CanImportExprSyntax(json)),
    "_CanImportVersionInfoSyntax"                  -> (json => _CanImportVersionInfoSyntax(json)),
    ...
    "CodeBlockFileSyntax"                          -> (json => CodeBlockFileSyntax(json)),
    ...
    "InlineArrayTypeSyntax"                        -> (json => InlineArrayTypeSyntax(json)),
    ...
    "KeyPathMethodComponentSyntax"                 -> (json => KeyPathMethodComponentSyntax(json)),
    ...
    "MemberBlockItemListFileSyntax"                -> (json => MemberBlockItemListFileSyntax(json)),
    ...
    "ModuleSelectorSyntax"                         -> (json => ModuleSelectorSyntax(json)),
    ...
    "NonisolatedSpecifierArgumentSyntax"           -> (json => NonisolatedSpecifierArgumentSyntax(json)),
    "NonisolatedTypeSpecifierSyntax"               -> (json => NonisolatedTypeSpecifierSyntax(json)),
    ...
    "SpecializedAttributeArgumentSyntax"           -> (json => SpecializedAttributeArgumentSyntax(json)),
    ...
    "UnexpectedCodeDeclSyntax"                     -> (json => UnexpectedCodeDeclSyntax(json)),
    ...
    "UnsafeExprSyntax"                             -> (json => UnsafeExprSyntax(json)),
    "UsingDeclSyntax"                              -> (json => UsingDeclSyntax(json)),
  ...
  private val _tokenKindMap: Map[String, Value => SwiftNode] = Map(
    ...
    "colonColon"              -> (json => colonColon(json)),
  ...
  case class colonColon(json: Value) extends SwiftToken
  ...
  /** ### Documentation
    ...
    * ### Children
    *
    *   - `provider`: (``AssociatedTypeDeclSyntax`` | ``DeinitializerDeclSyntax`` | ``EnumCaseDeclSyntax`` |
    *     ``FunctionDeclSyntax`` | ``InitializerDeclSyntax`` | ``MissingDeclSyntax`` | ``SubscriptDeclSyntax`` |
    *     ``TypeAliasDeclSyntax`` | ``VariableDeclSyntax``)
    *
    * ### Contained in
    *
    *   - ``AttributeSyntax``.``AttributeSyntax/arguments``
    */
  case class ABIAttributeArgumentsSyntax(json: Value) extends Syntax {
    def provider: AssociatedTypeDeclSyntax | DeinitializerDeclSyntax | EnumCaseDeclSyntax | FunctionDeclSyntax |
      InitializerDeclSyntax | MissingDeclSyntax | SubscriptDeclSyntax | TypeAliasDeclSyntax | VariableDeclSyntax =
      createSwiftNode(_childrenMap("provider")).asInstanceOf[
        AssociatedTypeDeclSyntax | DeinitializerDeclSyntax | EnumCaseDeclSyntax | FunctionDeclSyntax |
          InitializerDeclSyntax | MissingDeclSyntax | SubscriptDeclSyntax | TypeAliasDeclSyntax | VariableDeclSyntax
      ]
  }
  ...
  /** ### Documentation
    ...
    */
  case class AccessorBlockFileSyntax(json: Value) extends Syntax {
    def leftBrace: Option[SwiftToken] =
      _childrenMap.get("leftBrace").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])

    def accessors: AccessorDeclListSyntax =
      createSwiftNode(_childrenMap("accessors")).asInstanceOf[AccessorDeclListSyntax]

    def rightBrace: Option[SwiftToken] =
      _childrenMap.get("rightBrace").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  ...
  /** ### Documentation
    ...
    *     `mutableAddressWithNativeOwner` | `_read` | `read` | `_modify` | `modify` | `init` | `borrow` | `mutate`)
  ...
  /** ### Documentation
    *
    * Syntax for 'memberAttribute' macro expansion or 'swift_attr' attribute in Clang, never appear in Swift source
    * code.
    *
    * ### Children
    *
    ...
    * ### Nowhere contained in
    */
  case class AttributeClauseFileSyntax(json: Value) extends Syntax with WithAttributes with WithModifiers {
    def attributes: AttributeListSyntax = createSwiftNode(_childrenMap("attributes")).asInstanceOf[AttributeListSyntax]
  ...
  /** ### Documentation
    ...
    *   - `leftParen`: `(`?
    *   - `arguments`: (``LabeledExprListSyntax`` | ``AvailabilityArgumentListSyntax`` |
    *     ``SpecializeAttributeArgumentListSyntax`` | ``SpecializedAttributeArgumentSyntax`` |
  ...
  case class AttributeSyntax(json: Value) extends Syntax {
    ...
    def arguments: Option[
      LabeledExprListSyntax | AvailabilityArgumentListSyntax | SpecializeAttributeArgumentListSyntax |
        SpecializedAttributeArgumentSyntax | ObjCSelectorPieceListSyntax | ImplementsAttributeArgumentsSyntax |
        DifferentiableAttributeArgumentsSyntax | DerivativeAttributeArgumentsSyntax |
        BackDeployedAttributeArgumentsSyntax | OriginallyDefinedInAttributeArgumentsSyntax |
        DynamicReplacementAttributeArgumentsSyntax | EffectsAttributeArgumentListSyntax |
        DocumentationAttributeArgumentListSyntax | ABIAttributeArgumentsSyntax
  ...
  case class AttributedTypeSyntax(json: Value) extends TypeSyntax with WithAttributes {
    ...
    def lateSpecifiers: TypeSpecifierListSyntax =
      createSwiftNode(_childrenMap("lateSpecifiers")).asInstanceOf[TypeSpecifierListSyntax]
  ...
  case class AvailabilityMacroDefinitionFileSyntax(json: Value) extends Syntax {
    ...
    def specs: AvailabilityArgumentListSyntax =
  ...
  /** ### Documentation
    ...
    * ### Nowhere contained in
    */
  case class _CanImportExprSyntax(json: Value) extends ExprSyntax {
    ...
    def versionInfo: Option[_CanImportVersionInfoSyntax] =
      _childrenMap.get("versionInfo").map(c => createSwiftNode(c).asInstanceOf[_CanImportVersionInfoSyntax])
  ...
  /** ### Documentation
    ...
    */
  case class _CanImportVersionInfoSyntax(json: Value) extends ExprSyntax {
  ...
  /** ### Documentation
    ...
    * ### Nowhere contained in
    */
  case class CodeBlockFileSyntax(json: Value) extends Syntax {
    def body: CodeBlockSyntax = createSwiftNode(_childrenMap("body")).asInstanceOf[CodeBlockSyntax]
  ...
  case class DeclReferenceExprSyntax(json: Value) extends ExprSyntax {
    def moduleSelector: Option[ModuleSelectorSyntax] =
      _childrenMap.get("moduleSelector").map(c => createSwiftNode(c).asInstanceOf[ModuleSelectorSyntax])
  ...
  case class ForStmtSyntax(json: Value) extends StmtSyntax with WithCodeBlock {
    ...
    def unsafeKeyword: Option[SwiftToken] =
      _childrenMap.get("unsafeKeyword").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  ...
  /** ### Documentation
    *
    * A list of function parameters that are type annotated and a label. The function parameters are represented by
  ...
  case class GenericArgumentSyntax(json: Value) extends Syntax with WithTrailingComma {
    def argument: TypeSyntax | ExprSyntax =
      createSwiftNode(_childrenMap("argument")).asInstanceOf[TypeSyntax | ExprSyntax]
    def trailingComma: Option[SwiftToken] =
      _childrenMap.get("trailingComma").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  }
  ...
  case class GenericParameterSyntax(json: Value) extends Syntax with WithTrailingComma with WithAttributes {
    def attributes: AttributeListSyntax = createSwiftNode(_childrenMap("attributes")).asInstanceOf[AttributeListSyntax]
    def specifier: Option[SwiftToken] =
      _childrenMap.get("specifier").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    def name: SwiftToken          = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    def colon: Option[SwiftToken] = _childrenMap.get("colon").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  ...
  case class InlineArrayTypeSyntax(json: Value) extends TypeSyntax {
    def leftSquare: SwiftToken         = createSwiftNode(_childrenMap("leftSquare")).asInstanceOf[SwiftToken]
    def count: GenericArgumentSyntax   = createSwiftNode(_childrenMap("count")).asInstanceOf[GenericArgumentSyntax]
    def separator: SwiftToken          = createSwiftNode(_childrenMap("separator")).asInstanceOf[SwiftToken]
    def element: GenericArgumentSyntax = createSwiftNode(_childrenMap("element")).asInstanceOf[GenericArgumentSyntax]
    def rightSquare: SwiftToken        = createSwiftNode(_childrenMap("rightSquare")).asInstanceOf[SwiftToken]
  }
  ...
  /** ### Documentation
    ...
    *
    *   - `period`: `.`?
    *   - `component`: (``KeyPathPropertyComponentSyntax`` | `KeyPathMethodComponentSyntax` |
    *     ``KeyPathSubscriptComponentSyntax`` | ``KeyPathOptionalComponentSyntax``)
    *
    * ### Contained in
    *
  ...
  case class KeyPathComponentSyntax(json: Value) extends Syntax {
    def period: Option[SwiftToken] = _childrenMap.get("period").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    def component: KeyPathPropertyComponentSyntax | KeyPathMethodComponentSyntax | KeyPathSubscriptComponentSyntax |
      KeyPathOptionalComponentSyntax = createSwiftNode(_childrenMap("component")).asInstanceOf[
      KeyPathPropertyComponentSyntax | KeyPathMethodComponentSyntax | KeyPathSubscriptComponentSyntax |
  ...
  case class LifetimeTypeSpecifierSyntax(json: Value) extends Syntax {
    def dependsOnKeyword: SwiftToken = createSwiftNode(_childrenMap("dependsOnKeyword")).asInstanceOf[SwiftToken]
    def leftParen: SwiftToken        = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    def scopedKeyword: Option[SwiftToken] =
      _childrenMap.get("scopedKeyword").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  ...
  /** ### Documentation
    ...
    * ### Nowhere contained in
    */
  case class MemberBlockItemListFileSyntax(json: Value) extends Syntax {
  ...
  /** ### Documentation
    ...
    * ### Contained in
    *
    *   - ``DeclReferenceExprSyntax``.``DeclReferenceExprSyntax/moduleSelector``
    *   - ``IdentifierTypeSyntax``.``IdentifierTypeSyntax/moduleSelector``
    ...
    */
  case class ModuleSelectorSyntax(json: Value) extends Syntax {
    def moduleName: SwiftToken = createSwiftNode(_childrenMap("moduleName")).asInstanceOf[SwiftToken]
    def colonColon: SwiftToken = createSwiftNode(_childrenMap("colonColon")).asInstanceOf[SwiftToken]
  }
  ...
  /** ### Documentation
    ...
    *
    * ### Example `data` in `func foo(data: nonisolated(nonsending) () async -> Void) -> X`
    *
    * ### Children
    *
    *   - `leftParen`: `(`
    ...
    */
  case class NonisolatedSpecifierArgumentSyntax(json: Value) extends Syntax with Parenthesized {
    def leftParen: SwiftToken         = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    def nonsendingKeyword: SwiftToken = createSwiftNode(_childrenMap("nonsendingKeyword")).asInstanceOf[SwiftToken]
    def rightParen: SwiftToken        = createSwiftNode(_childrenMap("rightParen")).asInstanceOf[SwiftToken]
  }
  ...
  /** ### Documentation
    ...
    *   - ``TypeSpecifierListSyntax``
    */
  case class NonisolatedTypeSpecifierSyntax(json: Value) extends Syntax {
    def nonisolatedKeyword: SwiftToken = createSwiftNode(_childrenMap("nonisolatedKeyword")).asInstanceOf[SwiftToken]
    def argument: Option[NonisolatedSpecifierArgumentSyntax] =
      _childrenMap.get("argument").map(c => createSwiftNode(c).asInstanceOf[NonisolatedSpecifierArgumentSyntax])
  }
  ...
  /** ### Documentation
    ...
    *   - ``AttributeSyntax``.``AttributeSyntax/arguments``
    */
  case class SpecializedAttributeArgumentSyntax(json: Value) extends Syntax {
    def genericWhereClause: GenericWhereClauseSyntax =
      createSwiftNode(_childrenMap("genericWhereClause")).asInstanceOf[GenericWhereClauseSyntax]
  }
  ...
  /** ### Documentation
    *
    * A statement used to indicate the produced value from an if/switch expression. * Written as:
    * {{{
    * then <expr>
    * }}}
    *
  ...
  case class TypeSpecifierListSyntax(json: Value) extends SyntaxCollection {
    def children: Seq[SimpleTypeSpecifierSyntax | LifetimeTypeSpecifierSyntax | NonisolatedTypeSpecifierSyntax] =
      json("children").arr.iterator
        .map(c =>
          createSwiftNode(c)
            .asInstanceOf[SimpleTypeSpecifierSyntax | LifetimeTypeSpecifierSyntax | NonisolatedTypeSpecifierSyntax]
        )
        .toSeq
  }
  ...
  /** ### Documentation
    ...
    * ### Nowhere contained in
    */
  case class UnexpectedCodeDeclSyntax(json: Value) extends DeclSyntax {
    def unexpectedCode: UnexpectedNodesSyntax =
      createSwiftNode(_childrenMap("unexpectedCode")).asInstanceOf[UnexpectedNodesSyntax]
  }
  ...
  /** ### Documentation
    ...
    * ### Nowhere contained in
    */
  case class UnsafeExprSyntax(json: Value) extends ExprSyntax {
    def unsafeKeyword: SwiftToken = createSwiftNode(_childrenMap("unsafeKeyword")).asInstanceOf[SwiftToken]
    def expression: ExprSyntax    = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  /** ### Documentation
    ...
    * ### Nowhere contained in
    */
  case class UsingDeclSyntax(json: Value) extends DeclSyntax {
    def usingKeyword: SwiftToken = createSwiftNode(_childrenMap("usingKeyword")).asInstanceOf[SwiftToken]
    def specifier: AttributeSyntax | SwiftToken =
      createSwiftNode(_childrenMap("specifier")).asInstanceOf[AttributeSyntax | SwiftToken]
  }
