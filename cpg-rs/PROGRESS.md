...
- **Production C convergence complete (2026-08-14).** The released
  `CFrontend`/`Project`/`standard_pipeline` path is the 114/114 committed Joern
  v4.0.555 oracle path, including 1,702/1,702 ReachingDef facts. Canonical
...
- **Gate:** `joern-parity/check.sh` — green, 114/114 blocks byte-identical.
