...
This document freezes the standalone Rust Java parser contract. The generator
emits a lossless syntax-tree JSON envelope that downstream lowering can consume
...
The source text and byte offsets are the compatibility anchor. Downstream CPG
lowering should derive code strings and offsets from these fields.
